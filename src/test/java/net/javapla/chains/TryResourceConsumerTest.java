...
public class TryResourceConsumerTest {
    ...
    public void tryWithStream() {
        ...
        Try.with(()->stream).perform((IntStream a) -> {a.forEach(i -> ints[0]++);}).execute();
    ...
    public void tryWithStreamClosed() throws Exception {
        Try.with(()->stream).perform((Stream a) -> {}).execute();
    ...
    public void tryWithStreamException() throws Exception {
        ...
        Try.with(()->stream).perform((Stream a) -> a.doSomething("")).exception((e)->System.out.println(e.getMessage())).execute();
    ...
    public void expect_RuntimeExceptionConversion_when_tryWithStreamExceptionNotExplicitCorrect() throws Exception {
        ...
        Try.with(()->stream).perform((Stream a) -> a.doSomething("")).exception((e)->System.out.println(e.getMessage()), NullPointerException.class).execute();
    }
    ...
    public void catchExceptionFromResourceUsage() {
        ...
        Try.with(()->stream).perform((Stream s) -> s.doException()).exception((e) -> {}).execute();
    ...
    public void catchExceptionExplicitlyFromResourceUsage() {
        ...
        Try.with(()->stream).perform((Stream s) -> s.doException()).exception((e) -> {}, NullPointerException.class).execute();
        verify(stream).doException();
    }
    ...
    public void handlingSubclassException() {
        ...
        Try.with(()->stream).perform((Stream s) -> s.doException()).exception((e) -> System.out.println(e.getMessage()), Exception.class).execute();
        verify(stream).doException();
        verify(System.out).println(anyString());
    }
